...
var _unitService = require('../services/unitService');

var _unitService2 = _interopRequireDefault(_unitService);
...
var UnitController = function () {
    ...
    _createClass(UnitController, null, [{
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 4:
                                _context.next = 6;
                                return _unitService2.default.isExist({ ip: data.ip });
                            ...
                            case 6:
                                ...
                                return _context.abrupt('return', ctx.error = { msg: 'ip为[' + data.ip + ']的单位ip已存在!' });

                            case 9:
                                _context.next = 11;
                                return _unitService2.default.add_unit(data);
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                id = ctx.params.id;
                                _context2.next = 3;
                                return _unitService2.default.delete_unit({ id: id });
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                delete data._id;
                                _context3.next = 6;
                                return _unitService2.default.edit_unit({ _id: _id }, data);
                            ...
                            case 6:
                                ...
                                return _context3.abrupt('return', ctx.body = { msg: '修改单位成功', data: result });

                            case 9:
                                return _context3.abrupt('return', ctx.error = { msg: '修改单位失败!' });
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                ...
                                _context4.next = 10;
                                return _unitService2.default.getTotal();
                            ...
                            case 10:
                                ...
                                _context4.next = 16;
                                return _unitService2.default.find_unit(filterObj, sortP, pagination);
                            ...
                            case 16:
                                ...
                                return _context4.abrupt('return', ctx.body = { msg: '查询单位', data: result, total: total });

                            case 19:
                                return _context4.abrupt('return', ctx.error = { msg: '没有找到单位!' });
        ...
        value: function () {
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                _context5.next = 6;
                                return _unitService2.default.findAll(sortP);
                            ...
                            case 6:
                                ...
                                return _context5.abrupt('return', ctx.body = { msg: '查询单位', data: result });

                            case 9:
                                return _context5.abrupt('return', ctx.error = { msg: '没有找到单位!' });
            ...
            function find_unit_noPage(_x5) {
                return _ref5.apply(this, arguments);
            }

            return find_unit_noPage;
        }()
    }, {
        key: 'find_one',
        value: function () {
                    ...
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
                                id = ctx.params.id;
                                _context6.next = 3;
                                return _unitService2.default.find_one(id);

                            case 3:
                                result = _context6.sent;

                                if (result) ctx.body = { msg: '查询单位', data: result };
                                return _context6.abrupt('return', ctx.error = { msg: '没有找到单位!' });
