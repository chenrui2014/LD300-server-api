...
var _vendorService = require('../services/vendorService');

var _vendorService2 = _interopRequireDefault(_vendorService);
...
var VendorController = function () {
    ...
    _createClass(VendorController, null, [{
        key: 'add_vendor',
        value: function () {
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 4:
                                _context.next = 6;
                                return _vendorService2.default.isExist({ vendorCode: data.vendorCode });
                            ...
                            case 6:
                                ...
                                return _context.abrupt('return', ctx.error = { msg: '厂商编码为[' + data.vendorCode + ']的厂商已存在!' });

                            case 9:
                                _context.next = 11;
                                return _vendorService2.default.add_vendor(data);
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                id = ctx.params.id;
                                _context2.next = 3;
                                return _vendorService2.default.delete_vendor({ id: id });
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                delete data._id;
                                _context3.next = 6;
                                return _vendorService2.default.edit_vendor({ _id: _id }, data);
                            ...
                            case 6:
                                ...
                                return _context3.abrupt('return', ctx.body = { msg: '修改厂商成功', data: result });

                            case 9:
                                return _context3.abrupt('return', ctx.error = { msg: '修改厂商失败!' });
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                ...
                                _context4.next = 13;
                                return _vendorService2.default.getTotal();
                            ...
                            case 13:
                                ...
                                _context4.next = 27;
                                return _vendorService2.default.find_vendor(filterObj, sortP, _pagination);
                            ...
                            case 30:
                                _context4.next = 32;
                                return _vendorService2.default.find_vendor(filterObj, sortP);
                            ...
                            case 35:
                                ...
                                _context4.next = 43;
                                return _vendorService2.default.find_vendor(filterObj, null, _pagination2);
                            ...
                            case 46:
                                _context4.next = 48;
                                return _vendorService2.default.find_vendor(filterObj);
                            ...
                            case 49:
                                ...
                                return _context4.abrupt('return', ctx.body = { msg: '查询厂商', data: result, total: total });

                            case 51:
                                return _context4.abrupt('return', ctx.error = { msg: '没有找到厂商!' });
        ...
        value: function () {
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                _context5.next = 6;
                                return _vendorService2.default.findAll(sortP);
                            ...
                            case 6:
                                ...
                                return _context5.abrupt('return', ctx.body = { msg: '查询厂商', data: result });

                            case 9:
                                return _context5.abrupt('return', ctx.error = { msg: '没有找到厂商!' });
            ...
            function find_vendor_noPage(_x5) {
                return _ref5.apply(this, arguments);
            }

            return find_vendor_noPage;
        }()
    }, {
        key: 'find_one',
        value: function () {
                    ...
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
                                id = ctx.params.id;
                                _context6.next = 3;
                                return _vendorService2.default.find_one(id);

                            case 3:
                                result = _context6.sent;

                                if (result) ctx.body = { msg: '查询厂商', data: result };
                                return _context6.abrupt('return', ctx.error = { msg: '没有找到厂商!' });
