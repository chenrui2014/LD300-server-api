...
var _PresetService = require('../services/PresetService');

var _PresetService2 = _interopRequireDefault(_PresetService);
...
var PresetController = function () {
    function PresetController() {
        _classCallCheck(this, PresetController);
    }

    _createClass(PresetController, null, [{
        key: 'add_preset',
        value: function () {
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 4:
                                _context.next = 6;
                                return _PresetService2.default.add_preset(data);
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                id = ctx.params.id;
                                _context2.next = 3;
                                return _PresetService2.default.delete_preset({ id: id });
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                delete data._id;
                                _context3.next = 6;
                                return _PresetService2.default.edit_preset({ _id: _id }, data);
                            ...
                            case 6:
                                ...
                                return _context3.abrupt('return', ctx.body = { msg: '修改预置点成功', data: result });

                            case 9:
                                return _context3.abrupt('return', ctx.error = { msg: '修改预置点失败!' });
        ...
        value: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4(ctx) {
                var _ctx$query, sort, range, filter, sortObj, rangeObj, filterObj, sortP, pageStart, pageEnd, total, pagination, result, hosts;
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                ...
                                _context4.next = 10;
                                return _PresetService2.default.getTotal();
                            ...
                            case 10:
                                ...
                                _context4.next = 16;
                                return _PresetService2.default.find_preset(filterObj, sortP, pagination);
                            ...
                            case 19:
                                ...
                                return _context4.abrupt('return', ctx.body = { msg: '查询预置点', data: result, total: total });

                            case 23:
                                return _context4.abrupt('return', ctx.error = { msg: '没有找到预置点!' });
        ...
        value: function () {
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                _context5.next = 6;
                                return _PresetService2.default.findAll(sortP);
                            ...
                            case 6:
                                ...
                                return _context5.abrupt('return', ctx.body = { msg: '查询预置点', data: result });

                            case 9:
                                return _context5.abrupt('return', ctx.error = { msg: '没有找到预置点!' });
            ...
            function find_preset_noPage(_x5) {
                return _ref5.apply(this, arguments);
            }

            return find_preset_noPage;
        }()
    }, {
        key: 'find_one',
        value: function () {
                    ...
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
                                id = ctx.params.id;
                                _context6.next = 3;
                                return _PresetService2.default.find_one(id);

                            case 3:
                                result = _context6.sent;

                                if (result) ctx.body = { msg: '查询预置点', data: result };
                                return _context6.abrupt('return', ctx.error = { msg: '没有找到预置点!' });
...
exports.default = PresetController;
