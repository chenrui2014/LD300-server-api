...
var dll = path.join(config.getLibDir(), iswin ? isX64 ? 'DHNetSDK/x64/dhnetsdk' : 'DHNetSDK/x32/dhnetsdk' : 'DHNetSDK/linux/libdhnetsdk.so');
...
callbacks.fSearchDevicesCB = function (fn) {
...
utils.structParser = function (_struct, data) {
    ...
    _.each(data.toObject(), function (val, key) {
        if (_struct.fields[key].type.name === 'ArrayType' && _struct.fields[key].type.type.name === 'char') {
...
exports = module.exports = function () {
    function DHLib() {
        ...
        this.asyncFunctions = {};
        _.each(this.functions, function (fun, name) {
            _this.asyncFunctions[name] = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                        ...
                        switch (_context.prev = _context.next) {
                            case 0:
                                return _context.abrupt('return', new Promise(function (resolve, reject) {
                                    fun.async.apply(_this, [].concat(argus, function (err, ret) {
...
//# sourceMappingURL=dhnetsdk.js.map