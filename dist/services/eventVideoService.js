...
var EventVideoModel = require('../models/eventVideo.model');
var uuidv1 = require('uuid/v1');

var EventVideoService = function () {
    function EventVideoService() {
        _classCallCheck(this, EventVideoService);
    }

    _createClass(EventVideoService, null, [{
        key: 'add_eventVideo',
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                success = false;
                                _context.next = 4;
                                return EventVideoModel.create(data, function (err, eventVideo) {
                                    if (!err) {
                                        success = true;
                                        logger.info('添加事件成功');
                                    } else {
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                success = false;
                                _context2.next = 3;
                                return EventVideoModel.remove(conditions, function (err, eventVideo) {
                                    if (!err) {
                                        success = true;
        ...
        value: function () {
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                result = null;
                                _context3.next = 3;
                                return EventVideoModel.update(conditions, data).exec();
            ...
            function edit_eventVideo(_x3, _x4) {
                ...
                return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                _context4.next = 2;
                                return EventVideoModel.find(conditions).count();
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                _context5.next = 3;
                                return EventVideoModel.find().sort(sort);
        ...
        value: function () {
                    ...
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
                                ...
                                _context6.next = 5;
                                return EventVideoModel.find(conditions).skip(pagination.pageStart).limit(pagination.pageSize).sort(sort);
                            ...
                            case 13:
                                ...
                                _context6.next = 16;
                                return EventVideoModel.find(conditions).skip(pagination.pageStart).limit(pagination.pageSize);
                            ...
                            case 19:
                                _context6.next = 21;
                                return EventVideoModel.find(conditions);
            ...
            function find_eventVideo(_x7, _x8, _x9) {
                ...
                return _regenerator2.default.wrap(function _callee7$(_context7) {
                    while (1) {
                        switch (_context7.prev = _context7.next) {
                            case 0:
                                _context7.next = 2;
                                return EventVideoModel.findOne({ id: id });
                ...
                return _regenerator2.default.wrap(function _callee8$(_context8) {
                    while (1) {
                        switch (_context8.prev = _context8.next) {
                            case 0:
                                _context8.next = 2;
                                return EventVideoModel.find().sort({ id: -1 }).limit(1);
...
//# sourceMappingURL=eventVideoService.js.map